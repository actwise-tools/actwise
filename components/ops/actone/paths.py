...
# Documented per-type Designer authoring flows (setup order, prerequisites, gotchas,
# doc citations) surfaced through describe_type().grounding.sequence. Override with
# ACTONE_DESIGNER_FLOWS. Ships in the wheel.
FLOWS = DATA / "designer-flows.yaml"
# Capability maturity, supported actions, object-type coverage, and verified builds.
# Override with ACTONE_DESIGNER_CAPABILITIES for a target-specific registry.
CAPABILITIES = DATA / "designer-capabilities.yaml"
