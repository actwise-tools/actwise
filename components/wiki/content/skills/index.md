...
| [docenter-live](docenter-live.md) | `docenter-mcp` server | Answer product questions strictly from the live documentation portal, always cited — never from general knowledge. |
...
| [copilot-studio-browser-testing](copilot-studio-browser-testing.md) | `agent-browser` CLI | Test/benchmark and record demo videos of Copilot Studio agents via the maker Preview pane when backend tooling is blocked. |
